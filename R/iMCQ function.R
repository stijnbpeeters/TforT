...
func_iMCQ <- function(dat, referentiejaar){
  ...
  col_names <-  c("n_GP",       #Amount of appointments with GP
                  ...
                  "u_DOMES",    #Amount of hours of domestic care help (homecare (DOMES)
                  "n_CAREH",    #Amount of weeks of care at home (homecare) (CAREH)
                  "u_CAREH",    #Amount of hours of care at home (homecare) (CAREH)
                  "n_NURSEH",   #Amount of weeks of nursing at home (homecare) (NURSEH)
                  "u_NURSEH",   #Amount of hours of nursing at home (homecare) (NURSEH)
